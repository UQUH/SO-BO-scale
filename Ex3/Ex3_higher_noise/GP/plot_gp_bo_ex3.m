%% Plot GP-based Bayesian Optimization Results for Ex3
% This script loads results from Python BO and generates publication-quality plots
%
% Usage:
%   1. Run bo_ex3.py in Python first to generate bo_ex3.mat
...
data = load(fullfile(results_dir, 'bo_ex3.mat'));
