...
noise_model = "hetero"
n_mc_var = 10           # Number of MC samples to estimate variance at each beta
noise_floor = 0.01      # Minimum noise variance in LOG space
...
base_results_dir = Path(custom_results_dir) if custom_results_dir else script_dir / "Results"
